...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic('assetss/images/menuBG.png');
		bg.scrollFactor.x = 0;
		...
		magenta = new FlxSprite(-80).loadGraphic('assetss/images/menuDesat.png');
		...
		var tex = FlxAtlasFrames.fromSparrow('assetss/images/FNF_main_menu_assets.png', 'assetss/images/FNF_main_menu_assets.xml');

		for (i in 0...optionShit.length)
		{
			var menuItem:FlxSprite = new FlxSprite(0, 90 + (i * 160));
			menuItem.frames = tex;
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "v" + Application.current.meta.get('version') + " || " + RealMainMenuState.chaosVer, 12);
