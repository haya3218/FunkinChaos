...
class OutdatedSubState extends MusicBeatState
{
	...
	override function create()
	{
		...
		"\nOk so basically you have the wrong version of chaos." +
		"\nGithub version is " + needVer +
		"\nYou have " + RealMainMenuState.chaosVer +
		"\nUpdate it twerp.", 32);
	...
	override function update(elapsed:Float)
	{
		if (controls.ACCEPT)
		{
			FlxG.openURL("https://github.com/The-SGPT/FunkinChaos");
		}
		if (controls.BACK)
		{
			leftState = true;
